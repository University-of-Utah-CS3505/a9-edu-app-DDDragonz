...
ChemistryLogicModel::ChemistryLogicModel(QObject *parent) : QObject{parent}, m_level(1)
{
...
void ChemistryLogicModel::addReactionRule(QList<QString> reactants, QList<QString> products)
{
    ...
    {
        productsConvert.append(m_chemicals[product]);
    }

    m_chemicals[reactants[0]].addReaction(m_chemicals[reactants[1]].getFormula(), productsConvert);
    m_chemicals[reactants[1]].addReaction(m_chemicals[reactants[0]].getFormula(), productsConvert);
}
...
QVector<QString> ChemistryLogicModel::simulateReaction(QString reactant1, QString reactant2)
{
    ...
    {
        if(!m_chemicals[reactant1].getReactions(reactant2).isEmpty() && !m_chemicals[reactant2].getReactions(reactant1).isEmpty())
        {
            QList<Chemical> productions = m_chemicals[reactant1].getReactions(reactant2);
